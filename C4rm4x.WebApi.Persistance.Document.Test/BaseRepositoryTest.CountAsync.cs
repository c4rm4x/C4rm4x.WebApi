...
namespace C4rm4x.WebApi.Persistance.Document.Test
{
    public partial class BaseRepositoryTest
    {
            ...
            BaseRepositoryFixture
        {
            ...
            public async Task CountAsync_Returns_The_Number_Of_All_Entities_In_Database()
            {
            ...
            {
                Assert.AreEqual(0, await _sut.CountAsync(e => e.Value == "0"));
            }

            [TestMethod, IntegrationTest]
            public async Task CountAsync_Returns_The_Total_Number_Of_Entities_In_Database_That_Fulfill_Predicate()
            {
                Assert.AreEqual(10, await _sut.CountAsync(e => e.Value != "0"));
            }
        }
    }
}
