...
{
    public partial class CheckHealthRequestValidatorTest
    {
        [TestClass]
        public class CheckHealthRequestValidatorValidateTest
        {
            [TestMethod, UnitTest]
            public void Validate_Returns_No_ValidationError_When_Components_Is_Empty_Collection()
            {
                Assert.IsFalse(
                    CreateSubjectUnderTest()
                        .Validate(new CheckHealthRequestBuilder()
                            .WithoutComponents()
                            .Build())
                        .Any());
            }
            ...
            private static CheckHealthRequestValidator CreateSubjectUnderTest()
            {
