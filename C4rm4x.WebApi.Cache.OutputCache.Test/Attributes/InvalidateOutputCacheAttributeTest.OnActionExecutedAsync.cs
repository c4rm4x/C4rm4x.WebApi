...
namespace C4rm4x.WebApi.Cache.OutputCache.Test
{
    ...
    {
        [TestClass]
        public class InvalidateOutputCacheAttributeOnActionExecutedAsyncTest
        {
            ...
            [TestMethod, UnitTest]
            public async Task OnActionExecutedAsync_Checks_Whether_Or_Not_The_Key_For_The_Given_Action_Name_Is_In_The_Cache_When_Response_Was_Successfully_Processed()
            {
                var cache = GetCache();
                ...
                Mock.Get(cache)
                    .Verify(c => c.ExistsAsync(GetKey(ActionName)), Times.Once());
            }
            ...
            public async Task OnActionExecutedAsync_Tries_To_Remove_The_Entry_From_The_Cache_When_The_Key_Is_Stored()
            {
                ...
                Mock.Get(cache)
                    .Verify(c => c.RemoveAsync(GetKey(ActionName)), Times.Once());
            }
