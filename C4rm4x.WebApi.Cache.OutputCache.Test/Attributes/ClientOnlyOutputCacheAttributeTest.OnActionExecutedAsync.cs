...
namespace C4rm4x.WebApi.Cache.OutputCache.Test
{
    ...
    {
        [TestClass]
        public class ClientOnlyOutputCacheAttributeOnActionExecutedAsyncTest
        {
            private const int DefaultClientTimeSpan = 60;

            [TestMethod, UnitTest]
            public async Task OnActionExecutedAsync_Does_Not_Set_CacheControl_Header_When_ActionExecutedAsyncContext_Response_Is_Not_Successfull()
            {
            ...
            [TestMethod, UnitTest]
            public async Task OnActionExecutedAsync_Does_Not_Set_CacheControl_Header_When_HttpMethod_Is_Delete()
            {
                var actionExecutedContext = GetHttpActionExecutedContext(HttpMethod.Delete);
            ...
            [TestMethod, UnitTest]
            public async Task OnActionExecutedAsync_Does_Not_Set_CacheControl_Header_When_HttpMethod_Is_Head()
            {
                var actionExecutedContext = GetHttpActionExecutedContext(HttpMethod.Head);
            ...
            [TestMethod, UnitTest]
            public async Task OnActionExecutedAsync_Does_Not_Set_CacheControl_Header_When_HttpMethod_Is_Options()
            {
                var actionExecutedContext = GetHttpActionExecutedContext(HttpMethod.Options);
            ...
            [TestMethod, UnitTest]
            public async Task OnActionExecutedAsync_Does_Not_Set_CacheControl_Header_When_HttpMethod_Is_Post()
            {
                var actionExecutedContext = GetHttpActionExecutedContext(HttpMethod.Post);
            ...
            [TestMethod, UnitTest]
            public async Task OnActionExecutedAsync_Does_Not_Set_CacheControl_Header_When_HttpMethod_Is_Put()
            {
                var actionExecutedContext = GetHttpActionExecutedContext(HttpMethod.Put);
            ...
            [TestMethod, UnitTest]
            public async Task OnActionExecutedAsync_Does_Not_Set_CacheControl_Header_When_HttpMethod_Is_Trace()
            {
                var actionExecutedContext = GetHttpActionExecutedContext(HttpMethod.Trace);
            ...
            [TestMethod, UnitTest]
            public async Task OnActionExecutedAsync_Does_Not_Set_CacheControl_Header_When_Is_A_Successful_Get_Response_But_Its_Content_Is_Null()
            {
                var actionExecutedContext = GetHttpActionExecutedContext(GetHttpResponseMessage(null));
            ...
            [TestMethod, UnitTest]
            public async Task OnActionExecutedAsync_Sets_CacheControl_Header_When_The_Response_Is_A_Successful_Get_Response_And_Has_Content()
            {
                var ClientTimeSpan = ObjectMother.Create<int>();
                var actionExecutedContext = GetHttpActionExecutedContext(GetContent().ToArray());

                await CreateSubjectUnderTest(ClientTimeSpan)
                    .OnActionExecutedAsync(actionExecutedContext, It.IsAny<CancellationToken>());
